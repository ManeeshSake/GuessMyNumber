        ...
        while (userAnswer != computerNumber) {
         ...
         String title = "Guessing Game"; // what type?
          int messageType = JOptionPane.INFORMATION_MESSAGE;
            ...
            JOptionPane.showMessageDialog(null, "" + caluculatemessage(userAnswer, computerNumber, count));
            count++;
        }
    }

    // TODO: Refactor / Rename determineGuess to calculateMessage
    public static String caluculatemessage(int userAnswer, int computerNumber, int count) {
